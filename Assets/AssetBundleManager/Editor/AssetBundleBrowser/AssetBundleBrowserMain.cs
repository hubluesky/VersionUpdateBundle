...
namespace UnityEngine.AssetBundles
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu
    {
        ...
        [MenuItem("Kola/AssetBundles/AssetBundle Browser", priority = 2050)]
        ...
        //[MenuItem("Kola/Test Build AssetBundle")]
        //static void TestBuildAssetBundle() {
        //    BuildAssetBundles(
        //        AssetBundleBuildTab.ValidBuildTarget.Android,
        //        AssetBundleBuildTab.CompressOptions.StandardCompression,
        //        true,
        //        false);
        //}

        public static void BuildAssetBundles(
            AssetBundleBuildTab.ValidBuildTarget buildTarget,
            AssetBundleBuildTab.CompressOptions compression,
            bool clearFolders,
            ...
            window.m_ManageTab.InitBundleTree();
            window.m_ManageTab.Update();
            window.m_ManageTab.ForceReloadData();

            var buildTab = window.m_BuildTab;
            buildTab.m_UserData.m_BuildTarget = buildTarget;
            buildTab.m_UserData.m_OutputPath = "AssetBundles/" + buildTarget.ToString();
            ...
            BundleAssetsMapMenuItems.PrepareBundleAssetsMap();
            buildTab.ExecuteBuild();
            window.Close();
        }

        public static void CleanAssetBundles(AssetBundleBuildTab.ValidBuildTarget buildTarget, bool cleanStreaming) {
            if(System.IO.Directory.Exists("AssetBundles/" + buildTarget.ToString()))
                System.IO.Directory.Delete("AssetBundles/" + buildTarget.ToString());
            if(cleanStreaming)
                AssetBundleBuildTab.CleanStreamingPath();
        }
