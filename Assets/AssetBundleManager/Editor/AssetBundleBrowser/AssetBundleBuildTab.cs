...
namespace UnityEngine.AssetBundles
{
    ...
    public class AssetBundleBuildTab
    {
        ...
        [SerializeField]
        internal BuildTabData m_UserData;

        List<ToggleData> m_ToggleData;
        internal ToggleData m_ForceRebuild;
        internal ToggleData m_CopyToStreaming;
        ...
        internal static void CleanStreamingPath() {
            string bundlePathMap = Path.Combine(m_streamingPath, typeof(BundleManifest).Name.ToLower());
            ...
            if (File.Exists(assetBundleManifest))
                File.Delete(assetBundleManifest);
        }

        internal void ExecuteBuild()
        {
            ...
            BundleAssetsMapMenuItems.RemoveBundleAssetsMap();
            ...
            Debug.Log("Build asset bundle completed. " + buildInfo.outputDirectory);
        }

        private static void DirectoryCopy(string sourceDirName, string destDirName, string excludesiveExt = "")
        {
            ...
            {
                if (!string.IsNullOrEmpty(excludesiveExt) && file.Name.EndsWith(excludesiveExt))
                    continue;
            ...
            foreach (DirectoryInfo subdir in dirs)
            {
                ...
                DirectoryCopy(subdir.FullName, temppath, excludesiveExt);
            }
        }
